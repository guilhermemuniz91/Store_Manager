...
describe('Testes endpoint GET do model Sales', function () {
  it('Verifica se retorna todas as vendas na rota /sales', async function () {
    sinon.stub(connection, 'execute').resolves([sales]);
    const result = await salesModel.readAllSales();
    expect(result).to.be.deep.equal(sales);
  });

  it('Verifica se retorna uma venda especifica pelo Id na rota /sales/:id', async function () {
